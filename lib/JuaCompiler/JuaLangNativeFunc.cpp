...
JuaCompileOprand JuaCompileTimeLexer::convert_DFMatcherRes(const DFMatcherRes& res) {
...
JuaCompileTimeLexer::JuaCompileTimeLexer() {
    TokenDFA ident_func;
...
std::vector<JuaCompileOprand> JuaCompileTimeLexer::insert_bytecode(const std::string& juax_code) {
